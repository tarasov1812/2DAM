...
public class QueryXML {
    ...
    private static String RESOURCE = "videojuego.xml";
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            col = DatabaseManager.getCollection(URI + COLLECTION, "admin", "Bilbao2024");
            ...
            if(res == null) {
                ...
                String xquery = "/base_de_datos/videojuego[anio < 2020]"; // Consulta para encontrar productos con precio menor a 50
