...
public class EmpresaDaoHibernate implements EmpresaDao {
	...
	public List<Empresa> obtenerTodasLasEmpresas() {
		try (Session session = sessionFactory.openSession()) {
			...
			e.printStackTrace();
			return null; // Devuelve una lista vacía o maneja el error de otra manera según tus
							// necesidades.
		}
	}
	...
	@Override
	public void actualizarEmpresa(Empresa empresa) { // En el objeto Empresa pones el id de la empresa que quieres
														// cambiar y el resto de datos de la nueva empresa
		Session session = sessionFactory.openSession();
		Transaction transaction = null;
