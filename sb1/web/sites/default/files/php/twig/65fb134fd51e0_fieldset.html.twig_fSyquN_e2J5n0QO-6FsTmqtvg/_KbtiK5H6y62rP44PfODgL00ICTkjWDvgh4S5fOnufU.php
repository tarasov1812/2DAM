...
class __TwigTemplate_9e5b1a908435b74c87fd93686857ef7b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 28
        $context["classes"] = ["w3-container", "js-form-item", "form-item", "js-form-wrapper", "form-wrapper"];
        // line 36
        echo "<fieldset";
  ...
  ";
        // line 37
        $context["legend_span_classes"] = ["w3-bar", "fieldset-legend", ((        // line 40
  ...
  <div class=\"fieldset-wrapper w3-panel\">
    ";
        ...
        if (((($context["description_display"] ?? null) == "before") && twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 49))) {
            // line 50
            echo "      <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 50), "addClass", ["w3-panel w3-small description"], "method", false, false, true, 50), 50, $this->source), "html", null, true);
            echo ">";
    ...
    ";
        ...
        // line 64
        echo "    ";
        if ((twig_in_filter(($context["description_display"] ?? null), ["after", "invisible"]) && twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 64))) {
            // line 65
            echo "      <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 65), "addClass", ["w3-panel w3-small description"], "method", false, false, true, 65), 65, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return array (  120 => 67,  112 => 65,  109 => 64,  103 => 62,  101 => 61,  96 => 60,  90 => 58,  87 => 57,  81 => 54,  78 => 53,  75 => 52,  67 => 50,  65 => 49,  57 => 46,  52 => 45,  50 => 44,  48 => 41,  47 => 40,  46 => 37,  41 => 36,  39 => 28,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/contrib/d8w3css/templates/form/fieldset.html.twig", "/home/alektara/home/alektara/public_html/sb/sb1/web/themes/contrib/d8w3css/templates/form/fieldset.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 28, "if" => 49);
