          ...
          <tr>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["cell"]) {
                ...
                if (twig_in_filter("<a", $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_get_attribute($this->env, $this->source, $context["cell"], "content", [], "any", false, false, true, 67))))) {
                    ...
                    echo "                ";
                    // line 69
                    $context["cell_classes"] = ["th__item", ((twig_get_attribute($this->env, $this->source,                     // line 71
$context["cell"], "active_table_sort", [], "any", false, false, true, 71)) ? ("is-active") : (""))];
                    ...
                    echo "                ";
                    // line 76
                    $context["cell_classes"] = [("th__" . \Drupal\Component\Utility\Html::getClass($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,                     // line 77
$context["cell"], "content", [], "any", false, false, true, 77), 77, $this->source)))), ((twig_get_attribute($this->env, $this->source,                     // line 78
$context["cell"], "active_table_sort", [], "any", false, false, true, 78)) ? ("is-active") : (""))];
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["cell"], "attributes", [], "any", false, false, true, 82), "addClass", [($context["cell_classes"] ?? null)], "method", false, false, true, 82), 82, $this->source), "html", null, true);
                echo ">";
                // line 83
...
($context["no_striping"] ?? null)) ? (twig_cycle(["odd", "even"], $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, true, 95), 95, $this->source))) : (""))];
                // line 98
                echo "            <tr";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 98), "addClass", [($context["row_classes"] ?? null)], "method", false, false, true, 98), 98, $this->source), "html", null, true);
                echo ">
              ";
                // line 99
                $context['_parent'] = $context;
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["header", "attributes", "caption", "colgroups", "rows", "no_striping", "loop", "empty", "header_columns", "footer"]);    }
    ...
    {
        return new Source("", "table.html.twig", "themes/contrib/gin/templates/dataset/table.html.twig");
    }
