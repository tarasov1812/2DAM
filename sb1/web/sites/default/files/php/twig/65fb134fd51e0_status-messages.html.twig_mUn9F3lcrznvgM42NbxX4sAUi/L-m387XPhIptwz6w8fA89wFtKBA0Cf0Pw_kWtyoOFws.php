...
class __TwigTemplate_9c81b068e6b14f7430136b4af791d057 extends Template
{
    private $source;
    private $macros = [];
...
$context["type"], 33, $this->source))];
      ...
      <div role=\"contentinfo\" aria-labelledby=\"";
            ...
            echo "\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 43), 43, $this->source), "role", "aria-label"), "html", null, true);
            echo ">
        ";
            // line 44
      ...
      ";
            // line 73
            echo "      ";
            $context["attributes"] = twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "removeClass", [($context["classes"] ?? null)], "method", false, false, true, 73);
            // line 74
            echo "    ";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return new Source("", "themes/contrib/gin/templates/misc/status-messages.html.twig", "/home/alektara/home/alektara/public_html/sb/sb1/web/themes/contrib/gin/templates/misc/status-messages.html.twig");
    }
